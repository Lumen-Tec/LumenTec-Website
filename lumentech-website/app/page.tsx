    ...
    <main className="min-h-screen bg-slate-50 selection:bg-indigo-100 selection:text-indigo-900">
      ...
      <section className="relative bg-gradient-to-br from-indigo-950 via-indigo-800 to-indigo-600 text-white pt-32 pb-32 overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          ...
          <div className="particle particle-sm absolute top-[15%] left-[50%] animate-particle delay-700"></div>
          <div className="particle particle-md absolute top-[80%] left-[40%] animate-particle delay-400"></div>
        </div>

        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10">
          <div className="text-center md:text-left max-w-4xl">
            <h1 className="text-4xl md:text-6xl font-extrabold tracking-tight mb-6 animate-fade-in-up">
              <span className="animate-gradient-text">Desarrollo de Software de Alto Rendimiento</span>
            </h1>
            <p className="text-lg md:text-xl text-indigo-100 max-w-2xl leading-relaxed font-light mb-4 animate-fade-in-up delay-200" style={{ animationFillMode: 'both' }}>
            ...
            <p className="text-base text-indigo-200/80 max-w-2xl leading-relaxed font-light mb-8 animate-fade-in-up delay-300" style={{ animationFillMode: 'both' }}>
              Desde startups hasta empresas consolidadas, ayudamos a construir productos digitales
              que destacan por su velocidad, diseño y experiencia de usuario excepcional.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start animate-fade-in-up delay-400" style={{ animationFillMode: 'both' }}>
              <Link
                href="/services"
                className="btn-shimmer inline-flex items-center justify-center px-8 py-4 border border-transparent text-base font-medium rounded-xl text-indigo-600 bg-white hover:bg-indigo-50 transition-all shadow-lg hover:shadow-xl hover:-translate-y-1 hover:scale-105"
              >
                Ver servicios
              ...
              <Link
                href="/about"
                className="inline-flex items-center justify-center px-8 py-4 border-2 border-white/30 text-base font-medium rounded-xl text-white hover:bg-white/10 hover:border-white/50 transition-all backdrop-blur-sm hover:-translate-y-1"
              >
                Conoce más
              </Link>
            </div>
            ...
            <div className="grid grid-cols-3 gap-8 mt-12 pt-8 border-t border-white/10 animate-fade-in-up delay-500" style={{ animationFillMode: 'both' }}>
              <div className="text-center md:text-left">
                <div className="text-3xl md:text-4xl font-bold text-white">24/7</div>
                <div className="text-indigo-200 text-sm">Soporte Disponible</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-24 py-20">
        ...
        <section id="servicios">
          <div className="text-center mb-12">
            <span className="inline-block px-4 py-1 rounded-full bg-indigo-100 text-indigo-700 text-sm font-semibold mb-4">Lo que hacemos</span>
            <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-4">
              Nuestros Servicios
            </h2>
            <p className="text-slate-600 text-lg max-w-2xl mx-auto">
              Soluciones tecnológicas diseñadas para impulsar tu negocio al siguiente nivel.
              Cada proyecto es único, y nuestro enfoque también lo es.
            </p>
          </div>
        ...
        <section id="sobre-nosotros">
          <div className="text-center mb-12">
            <span className="inline-block px-4 py-1 rounded-full bg-indigo-100 text-indigo-700 text-sm font-semibold mb-4">Quiénes somos</span>
            <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-4">
              Sobre Nosotros
            </h2>
            <p className="text-slate-600 text-lg max-w-2xl mx-auto">
              Un equipo de desarrolladores apasionados construyendo soluciones digitales innovadoras en Costa Rica
            </p>
          </div>
